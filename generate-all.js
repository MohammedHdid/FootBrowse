...
const rawData = [
  ...
  "Japan|Kaoru Mitoma|Midfielder|9|Brighton|Premier League|29|35|12|0|1|40000000|Dribbling|Pace|Agility",
  ...
  "Sweden|Dejan Kulusevski|Midfielder|21|Tottenham Hotspur|Premier League|26|50|8|0|0|55000000|Work rate|Dribbling|Passing",
  ...
  "New Zealand|Marko Stamenić|Midfielder|8|Red Star Belgrade|Serbian SuperLiga|24|25|2|0|0|6000000|Passing|Work rate|Tackling",
  ...
  "Iraq|Aymen Hussein|Forward|18|Al-Quwa Al-Jawiya|Iraq Stars|30|85|40|0|0|1500000|Aerial threat|Strength|Finishing",
  ...
  "Norway|Alexander Sørloth|Forward|19|Atlético Madrid|La Liga|30|65|25|0|0|30000000|Strength|Aerial|Finishing",

  // Group J
  "Argentina|Lionel Messi|Forward|10|Inter Miami|MLS|38|195|115|13|5|20000000|Playmaking|Dribbling|Vision",
  "Argentina|Emiliano Martínez|Goalkeeper|23|Aston Villa|Premier League|33|55|0|0|1|28000000|Shot stopping|Reflexes|Positioning",
  ...
  "Ghana|Mohammed Kudus|Midfielder|20|West Ham|Premier League|25|35|12|2|1|50000000|Dribbling|Finishing|Pace",
...
for (const line of rawData) {
  ...
  const o1 = `${nm} is a highly rated ${pos.toLowerCase()} playing for the ${team.name} national squad.`;
  const o2 = `He plays his club football for ${cb} in the ${lg} and aims to make a massive impact at the 2026 World Cup.`;
...
if (players.length !== 144) {
    console.error(`ERROR: Found ${players.length} instead of 144!`);
}
